    ...
    def _initialize_database(self):
        ...
        try:
            with pyodbc.connect(self.sql_conn_str) as conn:
                ...
                cursor.execute("""
                    IF NOT EXISTS (SELECT * FROM sysobjects WHERE name='bloomberg_requests' AND xtype='U')
                ...
                cursor.execute("""
                    IF NOT EXISTS (SELECT * FROM sysobjects WHERE name='bloomberg_responses' AND xtype='U')
